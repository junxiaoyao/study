...
public class ProxyBySsistDemo {
    public static void main(String[] args) throws Exception {
 /*       ClassPool pool = ClassPool.getDefault();
        CtClass ctClass = pool.get("javassist.User");
        CtMethod ctMethod = ctClass.getDeclaredMethod("say");
        ctMethod.insertBefore(" System.out.println(\"I am a javassist\");");
        ctClass.writeFile("F:/test");*/
        ProxyBySsistDemo proxyBySsistDemo = new ProxyBySsistDemo();
        User u=(User) proxyBySsistDemo.getProxy(User.class);
        u.say();
        u.superS();
    }
    ...
    public Object getProxy(Class clazz) throws InstantiationException, IllegalAccessException {
        ...
        proxyFactory.setHandler(new MethodHandler() {
            ...
            public Object invoke(Object self, Method thismethod, Method proceed, Object[] args) throws Throwable {
                ...
                System.out.println("代理类对方法的代理引用:" + thismethod.getName()+ "----"+proceed.getName());
